...
tree에 prim을 만들거나 asset reference를 추가한다는 뜻입니다. 이후 Day 8에서는 table, cube,
...
cube나 prop은 Day 8의 task object를 위한 작은 예고편입니다. cube-pick에서는 cube가 매번 같은
...
- scripted scene creation이 Day 8 deterministic cube-pick에 필요한 이유를 설명할 수 있습니다.
...
reset은 experiment를 known starting state로 되돌립니다. 이 구조가 Day 8 deterministic cube-pick의
기초입니다.
