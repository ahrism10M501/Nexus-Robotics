...
# -- loading SimulationManager -- #
from isaacsim.core.simulation_manager import SimulationManager
from isaacsim.examples.base.base_sample_experimental import BaseSample
from isaacsim.storage.native import get_assets_root_path

# ---- Hello Robot Tutorial import ---- #
import carb
...
class HelloWorld(BaseSample):
    ...
    def send_robot_actions(self, dt, context):
        random_velocities = np.array([[10.0, 5.0]]) # Shape: (1, num_dofs)
        self._jetbot.set_dof_velocity_targets(random_velocities, dof_indices=self._wheel_indices)
