...
assert_array 'core doctor argv' NEXUS_DOCTOR_ARGV scripts/doctor.bash base
...
assert_array 'isaac-host doctor argv' NEXUS_DOCTOR_ARGV scripts/doctor.bash isaac-host
